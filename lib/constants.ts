...
/** PoC display scale for MQ-135 ADC — not clinical breath ammonia (ppb shown 1:1 in UI). */
export const MQ135_RANGE = { min: 150, max: 400 };
/** PoC normalized MQ-3 ratio (0.1–0.8); UI converts to ppb via ×500 — not clinical acetone. */
