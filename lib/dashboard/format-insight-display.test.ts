...
describe("format-insight-display", () => {
  it("splits Thai summary into lead, factors, and conclusion", () => {
    const summary =
      "แอมโมเนียในลมหายใจ (308 ppb) สูงกว่าเกณฑ์อ้างอิง ขณะที่อะซิโทน (180 ppb) อยู่ในเกณฑ์อ้างอิง ประกอบกับประวัติโรคเบาหวาน ระบบประเมินการคัดกรองความเสี่ยงโรคไตในระดับปานกลาง — ควรติดตามและพิจารณาปรึกษาแพทย์หากค่ายังสูง";
